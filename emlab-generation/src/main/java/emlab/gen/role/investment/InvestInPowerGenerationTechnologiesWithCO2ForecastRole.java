...
public class InvestInPowerGenerationTechnologiesWithCO2ForecastRole<T extends EnergyProducer> extends
    ...
    public void act(T agent) {
        ...
        for (PowerGeneratingTechnology technology : reps.genericRepository.findAll(PowerGeneratingTechnology.class)) {
            ...
            logger.warn("CO2 Forecast 161 - Agent " + agent + " invested in technology at tick " + getCurrentTick()
        ...
        if (bestTechnology != null) {
            ...
            logger.warn("CO2 Forecast 343 - Agent " + agent + " invested in technology at tick " + getCurrentTick()
                    + " in tech " + bestTechnology);
        ...
        MarketInformation(ElectricitySpotMarket market, Map<ElectricitySpotMarket, Double> expectedDemand,
            ...
            for (PowerGeneratingTechnologyTarget pggt : reps.powerGenerationTechnologyTargetRepository
                ...
                if (targetDifference > 0) {
                    ...
                    logger.warn("CO2 Forecast 511 - Agent " + "WHO" + " invested in technology at tick "
